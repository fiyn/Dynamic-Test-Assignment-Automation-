...
WebUI.setText(findTestObject('01 - Login/TC_001_Login/Page_Busyzeus/input_Email_email'), email)
...
WebUI.waitForElementVisible(findTestObject('01 - Login/TC_002_LoginInvalidEmail/Page_Busyzeus/div_User not found with given email'), 
    2)

WebUI.verifyElementVisible(findTestObject('01 - Login/TC_002_LoginInvalidEmail/Page_Busyzeus/div_User not found with given email'))
