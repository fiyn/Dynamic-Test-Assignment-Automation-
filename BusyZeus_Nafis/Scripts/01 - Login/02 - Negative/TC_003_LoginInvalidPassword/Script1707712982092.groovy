...
WebUI.setEncryptedText(findTestObject('01 - Login/TC_001_Login/Page_Busyzeus/input_Password_password'), password)

WebUI.click(findTestObject('01 - Login/TC_001_Login/Page_Busyzeus/button_Login'))

WebUI.waitForElementVisible(findTestObject('01 - Login/TC_003_LoginInvalidPassword/Page_Busyzeus/div_Given credentials are invalid'), 
    2)

WebUI.verifyElementVisible(findTestObject('01 - Login/TC_003_LoginInvalidPassword/Page_Busyzeus/div_Given credentials are invalid'))
