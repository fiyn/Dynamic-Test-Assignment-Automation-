...
WebUI.click(findTestObject('03 - Vacancies/05 - Search Candidates/TC_022_SearchCandidatesIndustry/Page_Busyzeus/div_IT'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('03 - Vacancies/05 - Search Candidates/TC_022_SearchCandidatesIndustry/Page_Busyzeus/span_Select Any Industry', 
        [('industry') : industry]))

WebUI.setText(findTestObject('03 - Vacancies/05 - Search Candidates/TC_023_SearchCandidatesKeyword/Page_Busyzeus/input_iii. Keyword_keyword'), 
    keyword)

WebUI.click(findTestObject('03 - Vacancies/05 - Search Candidates/TC_026_ClearSearchCandidates/Page_Busyzeus/button_Reset'))
