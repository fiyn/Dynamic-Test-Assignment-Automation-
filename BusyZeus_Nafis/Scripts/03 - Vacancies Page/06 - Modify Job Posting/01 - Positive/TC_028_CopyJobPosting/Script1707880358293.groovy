...
WebUI.click(findTestObject('03 - Vacancies/06 - Modify Job Posting/TC_028_CopyJobPosting/Page_Busyzeus/a_Copy'))
...
WebUI.sendKeys(findTestObject('02 - Job Posting/TC_006_PostJob/Page_Busyzeus/textarea_a) Description_description'), Keys.chord(
        Keys.LEFT_CONTROL, 'a'))
...
WebUI.sendKeys(findTestObject('02 - Job Posting/TC_006_PostJob/Page_Busyzeus/input_b) Responsibilities_responsiblities'), 
